...
parser.add_argument('--num_point', type=int, default=448, help='Point Number [256/512/1024/2048] [default: 1024]')
parser.add_argument('--max_epoch', type=int, default=120, help='Epoch to run [default: 250]')
...
def train():
    with tf.Graph().as_default():
        ...
        save_path = saver.save(sess, os.path.join(LOG_DIR, "contrastnet.ckpt"))
