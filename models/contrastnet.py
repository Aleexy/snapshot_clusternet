...
def get_model(point_cloud_1, point_cloud_2, is_training, bn_decay=None):
  ...
  batch_size = point_cloud_1.get_shape()[0]
  num_point = point_cloud_1.get_shape()[1]
  end_points = {}
...
def get_constra_loss(feat1, feat2, label, end_points):
  """ feat1: B*256,
      feat2: B*256,
      label: B, """
  feat1 = tf.math.l2_normalize(feat1, axis=0, epsilon=1e-12, name=None)
  feat2 = tf.math.l2_normalize(feat2, axis=0, epsilon=1e-12, name=None)
